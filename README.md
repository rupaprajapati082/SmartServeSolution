...
● To introduce online payment facility
...
● Difficulty in tracking service status
● Delays in customer updates
...
● Admin can manage and assign services
...
● Role-based access (Customer, Admin, Technician)
...
payments.
󰳖 Service Manager (Admin)
Admin manages the entire system including service requests, technicians, and
payments.
󰳗 Technician
...
● Payment depends on payment gateway
● Assumptions
...
FR-3: The system shall allow admins to assign technicians.
FR-4: The system shall allow technicians to update service status.
FR-5: The system shall allow customers to make online payments.
...
improved customer experience, and digital transformation.
